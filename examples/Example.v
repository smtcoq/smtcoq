...
(** [From SMTCoq Require Import SMTCoq.] loads the SMTCoq library. *)
...
Section ZChaff.
  ...
  Zchaff_Checker "files/sat.cnf" "files/sat.zlog".

  Zchaff_Theorem sat "files/sat.cnf" "files/sat.zlog".
  Check sat.

  Zchaff_Checker "files/hole4.cnf" "files/hole4.zlog".
...
Section Verit.
  ...
  Verit_Checker "files/lia.smt2" "files/lia.vtlog".
...
Section Lfsc.
  ...
  (* If you receive error messages saying that "sat.plf" cannot be found, *)
  (* make sure that you have set the LFSCSIGS environment variable correctly. *)

  Lfsc_Checker "files/lia.smt2" "files/lia.lfsc".

End Lfsc.


(** Examples of the zchaff tactic
  *  - with booleans
  *  - with concrete terms **)
(* It requires zchaff in your PATH. *)
