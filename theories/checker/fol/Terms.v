...
From Stdlib Require Import Bool Uint63 Psatz BinNat BinPos List ZArith.
...
Qed.
  ...
  (* Binary operators *)
        destruct op as [ | | | | | | | A |s1|s2| s3 | s4 | s6 | s7 | s8 | s9 | s10 | n | ti te | ti te];
          [ intros [ ti' te' | i | | | |s ] |
            intros [ ti' te' | i | | | |s ] |
            intros [ ti' te' | i | | | |s ] |
            intros [ ti' te' | i | | | |s ] |
...
Register Typ.type as SMTCoq.checker.fol.Terms.Typ.type.
Register Typ.TFArray as SMTCoq.checker.fol.Terms.Typ.TFArray.
Register Typ.Tindex as SMTCoq.checker.fol.Terms.Typ.Tindex.
Register Typ.TZ as SMTCoq.checker.fol.Terms.Typ.TZ.
Register Typ.Tbool as SMTCoq.checker.fol.Terms.Typ.Tbool.
Register Typ.Tpositive as SMTCoq.checker.fol.Terms.Typ.Tpositive.
Register Typ.TBV as SMTCoq.checker.fol.Terms.Typ.TBV.
Register Typ.interp as SMTCoq.checker.fol.Terms.Typ.interp.
Register Typ.eqb_interp as SMTCoq.checker.fol.Terms.Typ.dec_interp.
Register Typ.ord_interp as SMTCoq.checker.fol.Terms.Typ.ord_interp.
Register Typ.comp_interp as SMTCoq.checker.fol.Terms.Typ.comp_interp.
Register Typ.inh_interp as SMTCoq.checker.fol.Terms.Typ.inh_interp.
Register Typ.i_eqb as SMTCoq.checker.fol.Terms.Typ.i_eqb.
Register Atom.tval as SMTCoq.checker.fol.Terms.Atom.tval.
Register Atom.Tval as SMTCoq.checker.fol.Terms.Atom.Tval.
Register Atom.CO_xH as SMTCoq.checker.fol.Terms.Atom.CO_xH.
Register Atom.CO_Z0 as SMTCoq.checker.fol.Terms.Atom.CO_Z0.
Register Atom.CO_BV as SMTCoq.checker.fol.Terms.Atom.CO_BV.
Register Atom.UO_xO as SMTCoq.checker.fol.Terms.Atom.UO_xO.
Register Atom.UO_xI as SMTCoq.checker.fol.Terms.Atom.UO_xI.
Register Atom.UO_Zpos as SMTCoq.checker.fol.Terms.Atom.UO_Zpos.
Register Atom.UO_Zneg as SMTCoq.checker.fol.Terms.Atom.UO_Zneg.
Register Atom.UO_Zopp as SMTCoq.checker.fol.Terms.Atom.UO_Zopp.
Register Atom.UO_BVbitOf as SMTCoq.checker.fol.Terms.Atom.UO_BVbitOf.
Register Atom.UO_BVnot as SMTCoq.checker.fol.Terms.Atom.UO_BVnot.
Register Atom.UO_BVneg as SMTCoq.checker.fol.Terms.Atom.UO_BVneg.
Register Atom.UO_BVextr as SMTCoq.checker.fol.Terms.Atom.UO_BVextr.
Register Atom.UO_BVzextn as SMTCoq.checker.fol.Terms.Atom.UO_BVzextn.
Register Atom.UO_BVsextn as SMTCoq.checker.fol.Terms.Atom.UO_BVsextn.
Register Atom.BO_Zplus as SMTCoq.checker.fol.Terms.Atom.BO_Zplus.
Register Atom.BO_Zminus as SMTCoq.checker.fol.Terms.Atom.BO_Zminus.
Register Atom.BO_Zmult as SMTCoq.checker.fol.Terms.Atom.BO_Zmult.
Register Atom.BO_Zlt as SMTCoq.checker.fol.Terms.Atom.BO_Zlt.
Register Atom.BO_Zle as SMTCoq.checker.fol.Terms.Atom.BO_Zle.
Register Atom.BO_Zge as SMTCoq.checker.fol.Terms.Atom.BO_Zge.
Register Atom.BO_Zgt as SMTCoq.checker.fol.Terms.Atom.BO_Zgt.
Register Atom.BO_eq as SMTCoq.checker.fol.Terms.Atom.BO_eq.
Register Atom.BO_BVand as SMTCoq.checker.fol.Terms.Atom.BO_BVand.
Register Atom.BO_BVor as SMTCoq.checker.fol.Terms.Atom.BO_BVor.
Register Atom.BO_BVxor as SMTCoq.checker.fol.Terms.Atom.BO_BVxor.
Register Atom.BO_BVadd as SMTCoq.checker.fol.Terms.Atom.BO_BVadd.
Register Atom.BO_BVmult as SMTCoq.checker.fol.Terms.Atom.BO_BVmult.
Register Atom.BO_BVult as SMTCoq.checker.fol.Terms.Atom.BO_BVult.
Register Atom.BO_BVslt as SMTCoq.checker.fol.Terms.Atom.BO_BVslt.
Register Atom.BO_BVconcat as SMTCoq.checker.fol.Terms.Atom.BO_BVconcat.
Register Atom.BO_BVshl as SMTCoq.checker.fol.Terms.Atom.BO_BVshl.
Register Atom.BO_BVshr as SMTCoq.checker.fol.Terms.Atom.BO_BVshr.
Register Atom.BO_select as SMTCoq.checker.fol.Terms.Atom.BO_select.
Register Atom.BO_diffarray as SMTCoq.checker.fol.Terms.Atom.BO_diffarray.
Register Atom.TO_store as SMTCoq.checker.fol.Terms.Atom.TO_store.
Register Atom.NO_distinct as SMTCoq.checker.fol.Terms.Atom.NO_distinct.
Register Atom.atom as SMTCoq.checker.fol.Terms.Atom.atom.
Register Atom.Acop as SMTCoq.checker.fol.Terms.Atom.Acop.
Register Atom.Auop as SMTCoq.checker.fol.Terms.Atom.Auop.
Register Atom.Abop as SMTCoq.checker.fol.Terms.Atom.Abop.
Register Atom.Atop as SMTCoq.checker.fol.Terms.Atom.Atop.
Register Atom.Anop as SMTCoq.checker.fol.Terms.Atom.Anop.
Register Atom.Aapp as SMTCoq.checker.fol.Terms.Atom.Aapp.
Register Form.form as SMTCoq.checker.fol.Terms.Form.form.
Register Form.Fatom as SMTCoq.checker.fol.Terms.Form.Fatom.
Register Form.Ftrue as SMTCoq.checker.fol.Terms.Form.Ftrue.
Register Form.Ffalse as SMTCoq.checker.fol.Terms.Form.Ffalse.
Register Form.Fnot2 as SMTCoq.checker.fol.Terms.Form.Fnot2.
Register Form.Fand as SMTCoq.checker.fol.Terms.Form.Fand.
Register Form.For as SMTCoq.checker.fol.Terms.Form.For.
Register Form.Fxor as SMTCoq.checker.fol.Terms.Form.Fxor.
Register Form.Fimp as SMTCoq.checker.fol.Terms.Form.Fimp.
Register Form.Fiff as SMTCoq.checker.fol.Terms.Form.Fiff.
Register Form.Fite as SMTCoq.checker.fol.Terms.Form.Fite.
Register Form.FbbT as SMTCoq.checker.fol.Terms.Form.FbbT.
