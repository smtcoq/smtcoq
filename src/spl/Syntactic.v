...
Section CheckAtom.
  ...
  Section AUX.
      ...
      match a, b with
        ...
        | Abop o1 a1 a2, Abop o2 b1 b2 =>
          match o1, o2 with
            ...
            | BO_BVand, BO_BVand
            | BO_BVor, BO_BVor => check_hatom a1 b1 && check_hatom a2 b2
            | _, _ => false
          end
    ...
    Proof.
      ...
      intros n m. simpl. unfold is_true. rewrite andb_true_iff, beq_nat_true_iff. intros [-> H]. rewrite (check_hatom_correct _ _ H); auto.
            (* Binary operators *)
