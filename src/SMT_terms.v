...
(*
    ...
    *)
    ...
    Proof.
      ...
      intros; subst; auto.
      intros.
      case_eq (BITVECTOR_LIST.bv_eq x y); intros.
      left. now apply BITVECTOR_LIST.bv_eq_reflect.
      right. unfold not.
      intros. subst.
      apply not_true_iff_false in H.
      unfold not in H.
      apply H. now apply BITVECTOR_LIST.bv_eq_reflect.
    Defined.
    ...
    Definition i_equiv (t:type) : interp t -> interp t -> Prop := fun x y => if i_eqb t x y then True else False.
      ...
      Proof.
        ...
        - intros.
          ...
          + apply BITVECTOR_LIST.bv_eq_reflect in H0. rewrite H0. apply i_eqb_refl.
      Qed.
...
Module Atom.
 ...
 (*  | CO_BV bv, CO_BV bv' => RAWBITVECTOR_LIST.beq_list bv bv' *)
  ...
  Proof.
    intros [ | | | | | | | A1|s1|s1 |s1 | s1 | s1 | s1 | s1 | s1 | s1 | I1 E1 ]
           [ | | | | | | | A2|s2|s2| s2 | s2 | s2 | s2 | s2 | s2 | s2 | I2 E2 ];
...
(*change -- DTBV.bb_nth_bv -- *)
  ...
  (* Binary operators *)
        destruct op as [ | | | | | | | A |s1|s2| s3 | s4 | s5 | s6 | s7 | s8 | n m | ti te];
          [ intros [ ti' te' | i | | | |s ] |
            intros [ ti' te' | i | | | |s ] |
            intros [ ti' te' | i | | | |s ] |
            intros [ ti' te' | i | | | |s ] |
