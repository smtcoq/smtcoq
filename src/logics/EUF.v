...
From SMTCoq.utils Require Import PArray State Classes.
...
Section certif.
  ...
  Section Proof.
    ...
    Variables (t_i : array Classes.typ_compdec)
    ...
    Proof.
      ...
      rewrite orb_true_iff, !andb_true_iff in H7;destruct H7 as
        [[H7 H8] | [H7 H8]].
      rewrite Uint63.eqb_spec in H7. rewrite Uint63.eqb_spec in H8. subst.
    ...
    Proof.
      ...
      rewrite orb_true_iff, !andb_true_iff in H5;destruct H5 as
        [ [H5 H7] | [H5 H7]].
      rewrite Uint63.eqb_spec in H5. rewrite Uint63.eqb_spec in H7. subst.
