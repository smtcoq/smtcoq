...
(* Bit vectors *)
let bv_prefix = "SMTCoq.structures.BVList.BITVECTOR_LIST"
...
(* Arrays *)
let array_prefix = "SMTCoq.structures.FArray"
let array_gc = gc array_prefix
...
(* SMTCoq Classes *)
let classes_prefix = "SMTCoq.utils.CompDec"
...
let classesi_prefix = "SMTCoq.structures.CompDecInstances"
...
(* SMTCoq Trace *)
let sat_checker_prefix = "SMTCoq.Checker.Sat_Checker"
...
let cnf_checker_prefix = "SMTCoq.Checker.Cnf_Checker"
...
let euf_checker_prefix = "SMTCoq.Checker.Euf_Checker"
